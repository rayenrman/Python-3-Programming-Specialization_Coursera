...
print('This program will draw any regular polygon, i.e. polygon with sides of same length')
number_of_sides_str = input('Enter the number of sides of the polygon: ')
number_of_sides = int(number_of_sides_str)
print('At 1080p on a 24-inch computer monitor, one inch = 92 pixels')
print('At 1080p on a 27-inch computer monitor, one inch = 82 pixels')
print('At 1080p on a 32-inch computer monitor, one inch = 70 pixels')
length_of_each_side_in_pixels_str = input('Enter the number of pixels for the length of each side: ')
length_of_each_side_in_pixels = int(length_of_each_side_in_pixels_str)
# print('type(number_of_sides_str:', type(number_of_sides_str))
# print('type(number_of_sides:', type(number_of_sides))
